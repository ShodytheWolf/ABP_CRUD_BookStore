...
* Check the `ConnectionStrings` in `appsettings.json` files under the `Acme.BookStore.Web` and `Acme.BookStore.DbMigrator` projects and change it if you need.
...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 554812ae-d3d0-4e5c-845d-78bd87e3d218
```

> `554812ae-d3d0-4e5c-845d-78bd87e3d218` is the password of the certificate, you can change it to any password you want.
